...
<html lang="en">
  ...
  <body class="nav-md">
                    ...
                    <form class="form-horizontal form-label-left"
                     action="../insert_problem.php" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" tabindex="-1"
                           required="required" name="ProblemType">
                            ...
                            <option value="特技">机械</option>
                            <option value="室外">电气</option>
                            <option value="其他">液压</option>
							<option value="其他">软件</option>
							<option value="其他">效果</option>
                      ...
                      <div class="item form-group">
                        ...
                        <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="datetime" class="form-control" placeholder="例如：15天"
	...
	<script src="../build/js/query_problem_artical.js"></script>
