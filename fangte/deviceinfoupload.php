                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form enctype="multipart/form-data" class="form-horizontal form-label-left"
                     action="../excel_device.php" method="post">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons_device" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>城市</th>
                          <th>公园</th>
