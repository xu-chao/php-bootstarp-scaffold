<?php
    ...
    */
    class Page {
        ...
        private $listNum = 14;                     //默认分页列表显示的个数
        ...
        private function pageList(){
            ...
            /*当前页的信息 */
            if($this->pageNum > 1)
                $linkPage .= "<span style='padding:1px 2px;background:#BB3D00;color:white'>{$this->page}</span>&nbsp;";
        ...
        private function goPage(){
                ...
                return '&nbsp;<input style="width:20px;height:17px !important;height:18px;border:0px solid #CCCCCC;" type="text" onkeydown="javascript:if(event.keyCode==13){var page=(this.value>'.$this->pageNum.')?'.$this->pageNum.':this.value;location=\''.$this->uri.'page=\'+page+\'\'}" value="'.$this->page.'"><input style="cursor:pointer;width:35px;height:18px;border:0px solid #CCCCCC;" type="button" value="GO" onclick="javascript:var page=(this.previousSibling.value>'.$this->pageNum.')?'.$this->pageNum.':this.previousSibling.value;location=\''.$this->uri.'page=\'+page+\'\'">&nbsp;';
            }
        }
