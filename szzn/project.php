                     ...
                     action="../insert_project.php" method="post">
                      ...
                      <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          class="form-control col-md-6 col-sm-6 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
          ...
          <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons_project" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>项目名</th>
                          <th>所属公园</th>
