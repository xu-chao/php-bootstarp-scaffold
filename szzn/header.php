        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <!--<li><a><i class="fa fa-edit"></i> 维修故障数据添加 <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
							...
							<li><a href="upload.php">详细问题批量录入</a></li>
                        </ul>
                    </li>-->
					...
					<li><a><i class="fa fa-cubes"></i> 大型设备信息登记 <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="equipment.php">全部信息</a></li>
                            <!--<li><a href="info.php">信息录入</a></li>
                            <li><a href="infoupload.php">批量信息录入</a></li>-->
                        </ul>
                    </li>
                </ul>
            </div>
